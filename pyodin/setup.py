...
setup(
    ...
    scripts = ['bin/run_ami.py', 'bin/run_f1com.py', 'bin/run_incall_fastagi.py', 'bin/run_sys.py'],
    ...
    package_data = {
        ...
        '': ['./config/*.sample.conf', './docs/*.ini'],
    },

    # metadata for upload to PyPI
    author = "vassilux",
    author_email = "vassili.gontcharov@gmail.com",
    description = "This is f1com compatible module",
    license = "MIT",
